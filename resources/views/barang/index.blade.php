...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h1 class="card-title">PUNYA GWEJH</h1>
            <br>
            <td>
                @if (session('success'))
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button class="btn btn-info" data-toggle="modal" data-target="#formBarangModal"
                                    ...
                                    data-no_telp="{{ $p->no_telp }}" data-harga_jual="{{ $p->harga_jual }}"
                                    data-stok="{{ $p->stok }}" data-ditarik="{{ $p->ditarik }}"
                                    data-user_id="{{ $p->user_id }}"><i class="fas fa-edit"></i></button>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
    ...
    <script>
        ...
        $('.btn-delete').on('click', function(e) {
            ...
            Swal.fire({
                icon: 'error',
                title: 'hapus data',
                html: `Hapus <b>${kode_barang}</br> engga?`,
